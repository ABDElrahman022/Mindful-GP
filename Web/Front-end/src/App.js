...
import ArticleDetails from './components/advicesarticles2/ArticleDetails.jsx';
import Notifications from './pages/Notifications';

function AppContent() {
  const location = useLocation();
  const hideNavbarPaths = ['/login_page', '/forgot_password'];
    ...
    <div>
      ...
      <Routes>
        ...
        <Route path="/registeration_page" element={<RegisterationPage />}>
          ...
          <Route path="as_doctor" element={<AsDoctor />} />
        </Route>
